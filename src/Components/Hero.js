        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img
              ...
              alt="hero"
              src="https://media.istockphoto.com/id/1179404709/photo/happy-family-with-trolley-shopping-together.jpg?s=170667a&w=0&k=20&c=ihprWChptXmY_iHHI-QeodLwDGpq7mxAiCMy-9ooBzU="
            />
          </div>
        </div>
      </section>
