  ...
  const handleCart = (product,redirect) => {
    ...
    if (isProductExist) {
      const updatedCart = AddToCart.map(item => {
        ...
        localStorage.setItem('AddToCart', JSON.stringify([...AddToCart, { ...product, quantity: 1 }]))
    }
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt={product.title}
              className="lg:w-1/2 w-full lg:h-auto max-h-[470px] h-64 object-contain object-center rounded"
              src={product?.image}
            />
